...
export function TermsAndConditions(props: TermsAndConditions.Props) {
  return (
    <ScrollablePage className={styles.policy}>
      <AppHelmet title="Terms & Conditions" />
      <PolicyHTML />
    </ScrollablePage>
  );
}
...
/**
 * Terms & Conditions HTML copied directly from policy generator
 */
const PolicyHTML = () => (
  <>
    ...
    <p>
      ...
      the &quot;Types of Data Collected&quot; section of this Privacy Policy. We
